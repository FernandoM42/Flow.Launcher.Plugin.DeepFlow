...
def translate(to_translate, to_language="en", from_language=""):
    ...
    agent = {
        "User-Agent": "Edge, Brave, Firefox, Chrome, Opera",
    ...
    def query(self, query):
        ...
        try:
            ...
            request = urllib.request.Request(
                "https://www.deepl.com/translator", headers=agent
            )
            ...
            # API key setter with tutorial
                ...
                "data" not in config
                or "api-key" not in config["data"]
                or config["data"]["api-key"].strip() == ""
            ):
                results.append(
                    {
                        "Title": "⚠️ API Key is missing!",
                        "SubTitle": "Please set your DeepL API key using: set-key <YOUR-API-KEY>",
                        "IcoPath": "Images/ico.png",
                        "ContextData": "ctxData",
                    }
                )
